...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	KEYMAP(
		...
		LCTL_T(KC_SCLN), LGUI_T(KC_SLSH), LALT_T(KC_MINS), LT(1, KC_SPC), LT(2, KC_SPC), KC_LEFT, KC_DOWN, KC_RGHT),
	...
	KEYMAP(
		...
		KC_TRNS, RESET, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LPRN, KC_PGUP, KC_RPRN,
	...
	KEYMAP(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_TRNS, KC_RBRC,
